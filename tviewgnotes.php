...
<body>
    ...
    <div class="container my-3">
        ...
        <div id="notesDisp" style="width: 100%;">
            ...
            displayAll("SELECT noteAuthor, noten, notec, isTeacher FROM groupnotes WHERE groupId=$id LIMIT 10");
            ...
            if(isset($_POST["searchBtn"])) {
                if ($_POST["searchTxt"] == "") {
                    ...
                    $sql = "SELECT noteAuthor, noten, notec, isTeacher FROM groupnotes WHERE groupId=$id AND 
                    (UPPER(notec) LIKE ? 
                    OR UPPER(noten) LIKE ?)";
