...
<body>
    ...
    <div class="container my-3">
        ...
        $sql = "SELECT * FROM notes WHERE noteAuthor=" . $_SESSION["teacher"] . " AND isTeacher=1";
    ...
    if (isset($_POST["addBtn"])) {
        ...
        if ($title != "" && $content != "") {
            $sql = "INSERT INTO notes (noteAuthor, noten, notec, isTeacher) VALUES ($_SESSION[teacher], '$title', '$content', 1)";
